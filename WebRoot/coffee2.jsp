      ...
      <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a id="change" href="coffee2.jsp">咖啡</a> </li>
    ...
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"><a href="product_d.jsp"><img src="images/cpffee/OMCCBGCB3.jpg" alt="Thumbnail Image 1" class="img-responsive"/></a>
        <div class="caption">
          ...
          <p>
          	<a href="doCartServlet?action=add&id=12&send=coffee2.jsp" class="btn btn-primary" role="button">加入购物车</a>
    ...
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"> <a href="#"><img src="images/cpffee/OMCCBESCB1.jpg" alt="Thumbnail Image 1" class="img-responsive"/></a>
        <div class="caption">
          ...
          <p><a href="doCartServlet?action=add&id=13&send=coffee2.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=13" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"> <a href="#"><img src="images/cpffee/OMCCBGCB2.jpg" alt="Thumbnail Image 1" class="img-responsive"/></a>
        <div class="caption">
          ...
          <p><a href="doCartServlet?action=add&id=14&send=coffee2.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=14" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <div class="thumbnail"> <a href="#"><img src="images/cpffee/OMCCBKCCB2.jpg" alt="Thumbnail Image 1" class="img-responsive"/></a>
        <div class="caption">
          ...
          <p class="font2">&yen; 198.00</p>
          <p><a href="doCartServlet?action=add&id=15&send=coffee2.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=15" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <div class="thumbnail"> <a href="#"><img src="images/cpffee/OMCCBCMBCB1.jpg" alt="Thumbnail Image 1" class="img-responsive"></a>
        <div class="caption">
          ...
          <p><a href="doCartServlet?action=add&id=16&send=coffee2.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=16" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <div class="thumbnail"> <a href="#"><img src="images/cpffee/OMCCBFDBCB1.jpg" alt="Thumbnail Image 1" class="img-responsive"></a>
        <div class="caption">
          ...
          <p><a href="doCartServlet?action=add&id=17&send=coffee2.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=17" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
  </div>
