...
<body>
    ...
    <div class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right hidden-sm">
        <li><a href="shopcart.jsp"><img src="images/carticon.png" width="25" height="21" alt=""/></a> </li>
            <li><a  class="loginfont" id="change" href="denglu.jsp">登录</a> </li>
  ...
  <!-- /.container-fluid --> 
    ...
    <div class="wrap">
        <div class="cont">
          <h1>登录One More Cup</h1>
          <h2>您的密码输入错误，请重新登录</h2>
            <form action="LoignServlet" method="post">
                <input type="text" placeholder="手机号码" name="tele"/>
                <input type="password" placeholder="密码" name="password"/>
                <input type="submit" value="登录"class="" id="sm"style="cursor:pointer;"/>
