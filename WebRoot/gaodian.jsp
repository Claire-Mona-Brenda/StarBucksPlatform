		...
		<nav>
			...
			<!-- Brand and toggle get grouped for better mobile display -->
				<div class="navbar-header">
					<a href="index.jsp"><img src="images/logo.png" width="158"
						height="43" alt="" /></a>
				</div>
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a id="change" href="gaodian.jsp">糕点</a></li>
					<li><a href="comment.jsp">社区</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right hidden-sm">
					<li><a href="shopcart.jsp"><img src="images/carticon.png"
			...
			<div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>
							<a href="doCartServlet?action=add&id=24&send=gaodian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
			...
			<div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p class="font2">&yen; 39.00</p>
						<p>
							<a href="doCartServlet?action=add&id=25&send=gaodian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
			...
			<div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>
							<a href="doCartServlet?action=add&id=26&send=gaodian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>
							<a href="doCartServlet?action=add&id=27&send=gaodian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p class="font2">&yen; 39.00</p>
						<p>
							<a href="doCartServlet?action=add&id=28&send=gaodian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p class="font2">&yen; 59.00</p>
						<p>
							<a href="doCartServlet?action=add&id=29&send=gaodian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
