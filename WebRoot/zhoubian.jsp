  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li><a id="change" href="zhoubian.jsp">周边</a> </li>
    ...
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"><a href="#"><img src="images/zhoubian/OMCCUFTC1.jpg" alt="Thumbnail Image 1" class="img-responsive"/></a>
        <div class="caption">
          ...
          <p><a href="doCartServlet?action=add&id=18&send=zhoubian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=18" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"> <a href="#"><img src="images/zhoubian/OMCOPCCG1.jpg" alt="Thumbnail Image 1" class="img-responsive"></a>
        <div class="caption">
          ...
          <p><a href="doCartServlet?action=add&id=19&send=zhoubian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=19" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"> <a href="#"><img src="images/zhoubian/OMCOPMGM2.jpg" alt="Thumbnail Image 1" class="img-responsive"></a>
        <div class="caption">
          ...
          <p><a href="doCartServlet?action=add&id=20&send=zhoubian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=20" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <div class="thumbnail"> <a href="#"><img src="images/zhoubian/OMCOPSSPC1.jpg" alt="Thumbnail Image 1" class="img-responsive"></a>
        <div class="caption">
          ...
          <p><a href="doCartServlet?action=add&id=21&send=zhoubian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=21" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <div class="thumbnail"> <a href="#"><img src="images/zhoubian/OMCSCPNG1.jpg" alt="Thumbnail Image 1" class="img-responsive"></a>
        <div class="caption">
			...
			<p class="font2">&yen; 399.00</p>
          <p><a href="doCartServlet?action=add&id=22&send=zhoubian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=22" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <div class="thumbnail"> <a href="#"><img src="images/zhoubian/OMCSCPNG2.jpg" alt="Thumbnail Image 1" class="img-responsive"></a>
        <div class="caption">
          <a href="#"><h3>满钻五角星项链星享卡节日礼品小</h3></a>
			<p class="font2">&yen; 399.00</p>
          <p><a href="doCartServlet?action=add&id=23&send=zhoubian.jsp" class="btn btn-primary" role="button">加入购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="doBuyServlet?id=23" class="btn btn-primary" role="button">&nbsp;立即购买&nbsp;</a></p>
        </div>
      </div>
    </div>
  </div>
