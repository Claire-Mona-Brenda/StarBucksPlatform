...
<body>
    ...
    <div class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right hidden-sm">
        <li><a href="shopcart.jsp"><img src="images/carticon.png" width="25" height="21" alt=""/></a> </li>
            ...
            <li><a  id="change" class="loginfont" href="zhuce.jsp">注册</a> </li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
  ...
  <!-- /.container-fluid --> 
     ...
     <div class="wrap">
        <div class="cont">
          <h1>欢迎加入One More Cup</h1><br>
          <h2>此账号已被注册！</h2>        
            <form>
                <input type="button" value="直接登录" onClick="location.href='denglu.jsp';" />
 				<input type="button" value="忘记密码" onClick="location.href='zhaohuimima.jsp';" />
                <input type="button" value="用其他手机号注册" onClick="location.href='zhuce.jsp';" />
          </form>
        </div>
        <ul>
            <li></li>
