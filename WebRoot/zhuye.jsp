    ...
    <nav>
  		<div class="container"> 
    		...
    		<div class="collapse navbar-collapse">
     			...
     			<li class="active"><a id="change" href="zhuye.jsp"> 首页 <span class="sr-only">(current)</span></a> </li>
      			...
      			<div class="thumbnail"> <a href="#"><img src="images/OMCCUFTC2.jpg" alt="Thumbnail Image 1" class="img-responsive"></a>
        			<div class="caption">
						<a href="#"><h3><%=name %> </h3></a>
          				...
          				<p><a href="doCartServlet?action=add&id=0&send=zhuye.jsp" class="btn btn-primary" role="button"> 加入购物车</a></p>
        			</div>
      			</div>
    		</div>
    		<div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      			<div class="thumbnail"> <a href="#"><img src="images/OMCCUSSKC1.jpg" alt="Thumbnail Image 1" class="img-responsive">
		  			<div class="caption"></a>
          				...
          				<p><a href="doCartServlet?action=add&id=1&send=zhuye.jsp" class="btn btn-primary" role="button">加入购物车</a> </p>
        			</div>
      			</div>
    		</div>
    		<div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      			<div class="thumbnail"> <a href="#"><img src="images/OMCOPCSB1.jpg" alt="Thumbnail Image 1" class="img-responsive">
		  			<div class="caption"></a>
          				...
          				<p><a href="doCartServlet?action=add&id=2&send=zhuye.jsp" class="btn btn-primary" role="button">加入购物车</a> </p>
       				 </div>
      			</div>
   			 </div>
  		</div>
     		 ...
     		 <div class="thumbnail"> <a href="product_d.jsp"><img src="images/OMCCBGCB3.jpg" alt="Thumbnail Image 1" class="img-responsive"/></a>
        		<div class="caption">
					<a href="product_d.jsp"><h3>危地马拉卡西塞罗咖啡豆</h3></a>
          			...
          			<p><a href="doCartServlet?action=add&id=3&send=zhuye.jsp" class="btn btn-primary" role="button">加入购物车</a> </p>
        		</div>
     		 </div>
    		</div>
    		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      			<div class="thumbnail"> <a href="#"><img src="images/OMCCBESCB1.jpg" alt="Thumbnail Image 1" class="img-responsive">
		  			<div class="caption"></a>
          				...
          				<p><a href="doCartServlet?action=add&id=4&send=zhuye.jsp" class="btn btn-primary" role="button">加入购物车</a> </p>
        			</div>
      			</div>
    		</div>
    		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      			<div class="thumbnail"> <a href="#"><img src="images/OMCCBGCB1.jpg" alt="Thumbnail Image 1" class="img-responsive">
		  			<div class="caption"></a>
          				...
          				<p><a href="doCartServlet?action=add&id=5&send=zhuye.jsp" class="btn btn-primary" role="button">加入购物车</a> </p>
        			</div>
      			</div>
   			 </div>
  		</div>
          			...
          			<div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
            			<div>
              				<ul class="list-unstyled">
                				...
                				<li> <a href="xinpin.jsp" class="font1">新品热卖</a> </li>
                				<li> <a href="gaodian.jsp" class="font1">糕点甜品</a> </li>
                				<li> <a href="zhoubian.jsp" class="font1">周边产品</a> </li>
                				<li> <a href="coffee.jsp" class="font1">咖啡</a> </li>
              				</ul>
            			</div>
          			</div>
          			<div class="col-sm-4 col-md-4 col-lg-4  col-xs-6">
